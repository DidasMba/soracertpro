      ...
      <div className="relative mt-14 sm:mt-24">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
            ...
            <div>
              ...
              >
                <ol role="list">
                  ...
                  {/* Ajouter plus d'éléments de programme */}
                </ol>
              </div>
            </div>
          </div>
          ...
          <div className="hidden lg:grid lg:grid-cols-3 lg:gap-x-8">
            <section>
              <h3 className="text-2xl font-semibold tracking-tight text-blue-900">
                <time dateTime="2022-04-04">April 456</time>
              </h3>
              <p className="mt-1.5 text-base tracking-tight text-blue-900">
                The first day of the conference is focused on dark patterns for ecommerce.
              </p>
              <ol className="mt-10 space-y-8 bg-white/60 px-10 py-14 text-center shadow-xl shadow-blue-900/5 backdrop-blur">
                {/* Liste des conférenciers pour le 4 avril */}
              </ol>
            </section>
            {/* Ajouter des sections similaires pour d'autres jours */}
          </div>
