...
import { saveTokenToLocalStorage } from "@/lib/api/baseUrl";
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="mt-4 border-t border-gray-100 pt-2">
            <div className="flex items-center gap-3">
              <Button isLoading={isSubmitting} type="submit" text="Connecter" />
              <Link
          ...
          {data?.error_message && <ErrorMessage text={data?.error_message} />}
        </div>
      </form>
    </div>
  );
