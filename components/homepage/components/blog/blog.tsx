...
export default function Component() {
    return (
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
            <Heading text={`Derniers articles de blog`} />
            <div className='mt-12 grid grid-cols-1 md:grid-cols-3 gap-8'>
                <div className='group relative'>
                    <Link href='/sora/blogue/1'>
                        <img
                        ...
                        <h3 className='text-lg font-semibold'>
                            5G : Impacts et opportunités pour les entreprises en
                            2024
                        </h3>
                ...
                <div className='flex flex-col'>
                    <Link href='/sora/blogue/2'>
                        ...
                        />
                        <h3 className='text-lg font-semibold'>
                            Les dernières innovations en matière d'intelligence
                            artificielle
                        </h3>
                        <p className='text-sm text-gray-600 mt-1'>
                ...
                <div className='flex flex-col'>
                    <Link href='/sora/blogue/3'>
                        ...
                        />
                        <h3 className='text-lg font-semibold'>
                            Les technologies qui redéfinissent l'avenir du cloud
                            computing
                        </h3>
                        <p className='text-sm text-gray-600 mt-1'>
