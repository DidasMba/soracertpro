...
<section className="max-w-7xl mx-auto w-full flex flex-col md:flex-ro justify-center items-center py-12 px-4"  data-aos="fade-up">
        ...
        <div className="w-full md:w-1/2 flex items-center"  data-aos="fade-up" data-aos-delay="200">
            ...
            Participez à des événements, programmes élaborés  par des experts du secteur, et mettez en pratique des projets concrets pour acquérir des compétences utiles. Développez un portfolio remarquable afin d'être prêt pour votre recherche d'emploi..</p>
        
         
            </div>
           
          </div>
          <div className="w-full md:w-1/2 space-y-8"  data-aos="fade-up" data-aos-delay="100">
