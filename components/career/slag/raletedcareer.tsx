...
const Raletedcareer = () => {
  return (
    ...
    <div className="faq-2 section py-5 max-w-8xl mx-auto " >
      <div className="flex items-center justify-center mt-4  p-3 m-4 max-w-7xl mx-auto">
           <h2 className="text-4xl font-extrabold tracking-tight text-gray-900" style={{textTransform:'uppercase'}}>Related Job</h2>
